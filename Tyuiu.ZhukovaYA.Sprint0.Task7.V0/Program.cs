using Tyuiu.ZhukovaYA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.ZhukovaYA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила: Жукова Я. А. | ИИПб-24-1";
            Console.WriteLine("***************************************************************************");
            ...
            if (arrayNums1.Length == arrayNums2.Length)
            {
                ...
                Console.WriteLine("Ошибка! Искходные массивы имеют разное количество элементов");
            Console.ReadKey();
        }
    }
}
